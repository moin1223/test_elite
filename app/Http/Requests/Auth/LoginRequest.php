...
class LoginRequest extends FormRequest
{
    ...
    {
        $this->loginField = filter_var($this->input('loginCred'), FILTER_VALIDATE_EMAIL) ? 'email' : 'user_id';
        $this->loginValue = $this->input('loginCred');
    ...
    public function rules(): array
    {
        return [
            ...
            'user_id' => ['required_without:email', 'string', 'exists:users,user_id'],
