                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h3 class="m-0">Authorized Partners</h3>
                        </div>
                    ...
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                <div class="add_button ms-2">
                                    {{-- @can('can_add_product') --}}
                                        <a href="{{ route('authorized-partner.create') }}" class="btn_1" style="padding: 5px">
                                            Create
                                        </a>
                                    {{-- @endcan --}}
                                </div>
                        ...
                        <div class="QA_table mb_30">
                            <table class="table lms_table_active">
                                ...
                                <tbody>
                                    @forelse ($authorizedPartners as $authorizedPartner)
                                        <tr>
                                            <td>{{ $authorizedPartner->name }}</td>
                                            
                                            <td><img src="{{ $authorizedPartner->image }}" class="w-50 rounded border border-warning">
                                            </td>
                                            <td>
                                                <div class="action_btns d-flex">
                                                    <a href="{{ route('authorized-partner.edit', $authorizedPartner->id) }}"
                                                        class="action_btn mr_10">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    @include('website.component.modal.delete-modal', [
                                                        'route' => 'authorized-partner.destroy',
                                                        'id' => $authorizedPartner->id,
                                                    ])
                                                </div>
                                            </td>
                                        </tr>
